...
public class SalarieAideADomicileService {
    ...
    public void clotureMois(SalarieAideADomicile salarieAideADomicile, double joursTravailles) throws SalarieException {
        ...
        // sauvegarde du bilan mensuel :
        SalarieAideADomicileMois salarieAideADomicileMois = salarieAideADomicileToMois(salarieAideADomicile);
        salarieAideADomicileMoisRepository.save(salarieAideADomicileMois);
    ...
    SalarieAideADomicileMois salarieAideADomicileToMois(SalarieAideADomicile salarieAideADomicile) {
        SalarieAideADomicileMois salarieAideADomicileMois = new SalarieAideADomicileMois();
        salarieAideADomicileMois.setJoursTravaillesAnneeN(salarieAideADomicile.getJoursTravaillesAnneeN());
        salarieAideADomicileMois.setCongesPayesAcquisAnneeN(salarieAideADomicile.getCongesPayesAcquisAnneeN());
        salarieAideADomicileMois.setJoursTravaillesAnneeNMoins1(salarieAideADomicile.getJoursTravaillesAnneeNMoins1());
        salarieAideADomicileMois.setCongesPayesAcquisAnneeNMoins1(salarieAideADomicile.getCongesPayesAcquisAnneeNMoins1());
        salarieAideADomicileMois.setCongesPayesPrisAnneeNMoins1(salarieAideADomicile.getCongesPayesPrisAnneeNMoins1());
        LocalDate moisEnCours = salarieAideADomicile.getMoisEnCours();
        salarieAideADomicileMois.setPremierDuMois(LocalDate.of(moisEnCours.getYear(), moisEnCours.getMonth(), 1));
        salarieAideADomicileMois.setSalarieAideADomicile(salarieAideADomicile);
        return salarieAideADomicileMois;
    }
